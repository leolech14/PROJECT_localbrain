---
title: "Central Intelligence – Orchestrator Actor"
module_id: "Central Intelligence"
type: "module"
category: "actor"
swift_actor: "CentralIntelligence"
swift_file: "LocalBrain/Services/CentralIntelligence.swift"
spec_probe_events: ["orch.input.received", "orch.context.selected", "orch.agents.deployed", "orch.response.emitted"]
lifecycle: "dev"
state: "minimal"
seat: "mvp"
...
observability:
  spec_events: ["orch.input.received", "orch.context.selected", "orch.agents.deployed", "orch.response.emitted"]
  metrics_captured: ["duration_ms","success_count","error_count"]
  spec_validation: ["SPEC/features/CentralIntelligence.spec.md"]
security:
