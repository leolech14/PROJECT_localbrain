---
title: "Realtime Session – Voice IO + Tool Calls"
module_id: "Realtime Session"
type: "module"
category: "actor"
swift_actor: "RealtimeSession"
swift_file: "LocalBrain/Services/RealtimeSession.swift"
spec_probe_events: ["realtime.session.start", "realtime.tool.call", "realtime.session.end"]
lifecycle: "dev"
state: "minimal"
seat: "mvp"
...
observability:
  spec_events: ["realtime.session.start", "realtime.tool.call", "realtime.session.end"]
  metrics_captured: ["duration_ms","success_count","error_count"]
  spec_validation: ["SPEC/features/RealtimeSession.spec.md"]
security:
