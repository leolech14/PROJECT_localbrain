---
title: "Browser Bridge – Chrome MCP / Embedded Browser"
module_id: "Browser Bridge"
type: "module"
category: "actor"
swift_actor: "BrowserBridge"
swift_file: "LocalBrain/Bridges/BrowserBridge.swift"
spec_probe_events: ["browser.open", "browser.navigate", "browser.inspect"]
lifecycle: "dev"
state: "minimal"
seat: "mvp"
...
observability:
  spec_events: ["browser.open", "browser.navigate", "browser.inspect"]
  metrics_captured: ["duration_ms","success_count","error_count"]
  spec_validation: ["SPEC/features/BrowserBridge.spec.md"]
security:
