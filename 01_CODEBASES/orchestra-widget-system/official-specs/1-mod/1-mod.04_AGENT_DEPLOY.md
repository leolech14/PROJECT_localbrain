---
title: "Agent Deployment Service – Multi-Model Router"
module_id: "Agent Deployment Service"
type: "module"
category: "actor"
swift_actor: "AgentDeploymentService"
swift_file: "LocalBrain/Services/AgentDeploymentService.swift"
spec_probe_events: ["agent.deploy", "agent.progress", "agent.complete"]
lifecycle: "dev"
state: "minimal"
seat: "mvp"
...
observability:
  spec_events: ["agent.deploy", "agent.progress", "agent.complete"]
  metrics_captured: ["duration_ms","success_count","error_count"]
  spec_validation: ["SPEC/features/AgentDeploymentService.spec.md"]
security:
