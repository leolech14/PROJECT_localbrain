---
title: "Claude Code CLI Controller – External Coder Agent"
module_id: "Claude Code CLI Controller"
type: "module"
category: "actor"
swift_actor: "ClaudeCodeCLIController"
swift_file: "LocalBrain/Agents/ClaudeCodeCLIController.swift"
spec_probe_events: ["claudecli.start", "claudecli.stdout", "claudecli.end"]
lifecycle: "dev"
state: "minimal"
seat: "mvp"
...
observability:
  spec_events: ["claudecli.start", "claudecli.stdout", "claudecli.end"]
  metrics_captured: ["duration_ms","success_count","error_count"]
  spec_validation: ["SPEC/features/ClaudeCodeCLIController.spec.md"]
security:
