...
struct WidgetContainer: View {
    ...
    private var widgetDisplayName: String {
        ...
        case "voice-orb": return "Voice Orb"
        case "browser": return "Browser"
        default: return widget.type.capitalized
        }
    }
}
