...
export const LocalBrainChat: FC = () => {
  const [messages] = Retool.useStateArray({
    name: 'messages',
    initialValue: []
  })
  
  const [isListening] = Retool.useStateBoolean({
    name: 'isListening',
    initialValue: false
  })
  ...
  const sendMessage = Retool.useEventCallback({
    name: 'sendMessage'
  })
...
export const LocalBrainTerminal: FC = () => {
  const [history] = Retool.useStateArray({
    name: 'history',
    initialValue: []
  })
  ...
  const executeCommand = Retool.useEventCallback({
    name: 'executeCommand'
  })
...
export const LocalBrainFileExplorer: FC = () => {
  const [files] = Retool.useStateArray({
    name: 'files',
    initialValue: []
  })
  
  const [selectedFile] = Retool.useStateString({
    name: 'selectedFile',
    initialValue: ''
  })
  ...
  const selectFile = Retool.useEventCallback({
    name: 'selectFile'
  })
