...
export class HealthCheckAPI {
   ...
   */
  private async handleBasicHealthCheck(res: any): Promise<void> {
   ...
   */
  private async handleDetailedHealthCheck(res: any): Promise<void> {
    const health = await this.monitor.checkHealth();
   ...
   */
  private async handlePrometheusMetrics(res: any): Promise<void> {
    const health = await this.monitor.checkHealth();
...
`.trim();
   ...
   * Current alerts
   */
  private async handleAlerts(res: any): Promise<void> {
