...
export class TaskRegistryClient {
     ...
     */
    async sendHeartbeat(currentActivity) {
        if (!this.sessionId) {
     ...
     * Get swarm dashboard
     */
    async getSwarmDashboard() {
        return this.callTool('get_swarm_dashboard', {});
    }
    async callTool(tool_name, parameters) {
    ...
    async getAvailableTasks(includeDetails = true) {
        return this.callTool('get_available_tasks', { includeDetails });
    }
    async claimTask(taskId) {
        return this.callTool('claim_task', { taskId });
    }
    async updateProgress(taskId, completionPercent, filesCreated, notes) {
    ...
    async completeTask(taskId, filesCreated, velocity) {
...
//# sourceMappingURL=TaskRegistryClient.js.map